...
import com.github.dankharlushin.myteambot.api.sportdata.service.impl.SdApiTeamServiceImpl
...
@SpringBootTest(
    classes = [SdApiTeamServiceImpl::class],
    webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@Import(SdApiTestConfiguration::class)
@DirtiesContext
class SdApiTeamServiceTest {

    @Autowired
    lateinit var teamService: SdApiTeamService
