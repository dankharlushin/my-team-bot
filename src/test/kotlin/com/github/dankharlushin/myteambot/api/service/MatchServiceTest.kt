...
class MatchServiceTest {
    ...
    fun testGetMatchesByTeamIdAndDate() {
        val dateFrom = LocalDate.of(2022, 7, 14)
        val dateTo = LocalDate.of(2022, 7, 17)
        val matches = matchService.getMatchesByTeamIdAndDate(3009, 8202, dateFrom, dateTo)
        ...
        assertEquals(matches[0].homeTeam.id, 8202)
    }
}